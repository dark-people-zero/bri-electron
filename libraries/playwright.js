...
class PW {
    ...
    async login(cb = 0) {
        if (this.captcha.text != null) {
            try {
                ...
                await this.page.waitForURL(config.url_homepage);
                ...
                await this.page.waitForResponse(config.url_account);
    ...
    async saldo() {
        ...
        try {
            ...
            await this.page.waitForResponse(config.url_saldo);
    ...
    async logout() {
        ...
        try {
            ...
            await this.page.waitForURL(config.url_logout);
